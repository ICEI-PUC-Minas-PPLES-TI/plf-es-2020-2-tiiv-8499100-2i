...
import 'package:inteligenciaindustrialapp/src/app/screens/register_company/name_company_screen.dart';
...
class PhoneEmployerScreen extends StatelessWidget {
  final dynamic body;

  PhoneEmployerScreen(this.body);
    ...
    return AppBar(
      ...
      actions: <Widget>[
        Container(
          ...
          child: Center(
            child: Text(
              '4/6 ${frwkLanguage.text('register_company.steps')}',
              style: TextStyle(
        ...
        child: Column(
          ...
          children: <Widget>[
            RichText(
              maxLines: 1,
              text: TextSpan(
                text: '${frwkLanguage.text('register_company.phone.what')} ',
                style: TextStyle(
                  color: ColorsStyle.gray,
                  fontWeight: FontWeight.normal,
                  fontSize: 16,
                ...
                children: <TextSpan>[
                  TextSpan(
                    text: frwkLanguage.text('register_company.phone.phone'),
                    style: TextStyle(
  ...
  _buildFooterButton() {
    return CustomButtonWidget(
      onPressed: () {
        var body = {};
        frwkNavigator.navigate(NameCompanyScreen(body));
      },
      title: Text(
        frwkLanguage.text('register_company.phone.confirm'),
        style: TextStyle(
