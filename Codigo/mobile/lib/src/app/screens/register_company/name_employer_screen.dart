...
import 'package:inteligenciaindustrialapp/src/app/screens/register_company/email_employer_screen.dart';
...
class NameEmployerScreen extends StatelessWidget {
  @override
    ...
    return AppBar(
      ...
      actions: <Widget>[
        Container(
          ...
          child: Center(
            child: Text(
              '1/6 ${frwkLanguage.text('register_company.steps')}',
              style: TextStyle(
        ...
        child: Column(
          ...
          children: <Widget>[
            RichText(
              maxLines: 1,
              text: TextSpan(
                text: '${frwkLanguage.text('register_company.name.what')} ',
                style: TextStyle(
                  color: ColorsStyle.gray,
                  fontWeight: FontWeight.normal,
                  fontSize: 16,
                ...
                children: <TextSpan>[
                  TextSpan(
                    text: frwkLanguage.text('register_company.name.name'),
                    style: TextStyle(
  ...
  _buildFooterButton() {
    return CustomButtonWidget(
      onPressed: () {
        var body = {};
        frwkNavigator.navigate(EmailEmployerScreen(body));
      },
      title: Text(
        frwkLanguage.text('register_company.name.confirm'),
        style: TextStyle(
