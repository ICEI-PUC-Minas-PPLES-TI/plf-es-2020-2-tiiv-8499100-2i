...
import 'package:inteligenciaindustrialapp/src/app/screens/register_company/password_employer_screen.dart';
...
class EmailEmployerScreen extends StatelessWidget {
  final dynamic body;

  EmailEmployerScreen(this.body);
    ...
    return AppBar(
      ...
      actions: <Widget>[
        Container(
          ...
          child: Center(
            child: Text(
              '2/6 ${frwkLanguage.text('register_company.steps')}',
              style: TextStyle(
          ...
          children: <Widget>[
            Flexible(
              child: RichText(
                ...
                text: TextSpan(
                  text:
                      'Gabriel, ${frwkLanguage.text('register_company.email.what')} ',
                  style: TextStyle(
                    color: ColorsStyle.gray,
                    fontWeight: FontWeight.normal,
                    fontSize: 16,
                  ...
                  children: <TextSpan>[
                    TextSpan(
                      text: frwkLanguage.text('register_company.email.email'),
                      style: TextStyle(
  ...
  _buildFooterButton() {
    return CustomButtonWidget(
      onPressed: () {
        var body = {};
        frwkNavigator.navigate(PasswordEmployerScreen(body));
      },
      title: Text(
        frwkLanguage.text('register_company.email.confirm'),
        style: TextStyle(
